...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmPurchase.aspx.cs" Inherits="BookingModule.ConfirmPurchase" %>
...
<body>
    ...
    <div>
        ...
        <p>
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="101px" Width="361px">
        ...
        <table style="width:49%;">
            ...
            <tr>
                <td class="auto-style37" >Blood B+&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                <td class="auto-style32">
    ...
    <asp:Button ID="btnConfirmBook" runat="server" style="border-radius: 8px; padding: 12px 28px; font-weight: bold" Text="Confirm" Width="159px" OnClick="btnConfirmBook_Click" PostBackUrl="~/BookingSummary.aspx" />
 </form>
</body>
</html>
