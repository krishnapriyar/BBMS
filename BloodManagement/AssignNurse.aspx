<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignNurse.aspx.cs" Inherits="BloodManagement.AssignNurse" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="text-align: center" Width="565px">
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            ...
            <table style="width: 62%;">
                <tr>
                    <td class="auto-style1">Donor Name</td>
                    <td class="auto-style2">
                        <asp:Label ID="lblDonor" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">Blood Type</td>
                    <td class="auto-style2">
                        <asp:Label ID="lblBT" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">Donation Time</td>
                    <td class="auto-style2">
                        <asp:Label ID="lblDT" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">Donation Date</td>
                    <td class="auto-style2">
                ...
                <tr>
                    <td class="auto-style1">Nurse In Charge</td>
                    <td class="auto-style2">
            ...
            <br />
            <asp:Button ID="lblConfirm" runat="server" style="margin-left: 51px; text-align: left; border-radius: 8px; padding: 12px 28px; font-weight: bold" Width="147px" OnClick="lblConfirm_Click" Text="Assign Nurse" />
        </asp:Panel>
        <p>
            &nbsp;</p>
    </form>
