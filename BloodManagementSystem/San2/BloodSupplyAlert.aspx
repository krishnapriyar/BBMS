<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BloodSupplyAlert.aspx.cs" Inherits="BloodManagementSystem.San.BloodSupplyAlert" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="Button1" runat="server" style="margin-left: 51px; text-align: left; border-radius: 8px; padding: 12px 28px; font-weight: bold" OnClick="Button1_Click" Text="Change Critical Quantity" />
        <br />
        ...
        <br />
        <asp:Button ID="Button2" runat="server" style="margin-left: 51px; text-align: left; border-radius: 8px; padding: 12px 28px; font-weight: bold" Text="Back To Menu" PostBackUrl="~/BloodManagement.aspx" />
        <br />
    </form>
</body>
</html>
