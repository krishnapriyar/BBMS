<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BloodUsageHistory.aspx.cs" Inherits="BloodManagementSystem.San.BloodUsageHistory" %>
        ...
        <p>
            ...
            <asp:TextBox ID="txtEnd" runat="server" TextMode="Date" AutoPostBack="True" OnTextChanged="txtEnd_TextChanged"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:Button ID="Button1" runat="server" style="margin-left: 51px; text-align: left; border-radius: 8px; padding: 12px 28px; font-weight: bold" Text="Track" Height="45px" Width="118px" />
                    </td>
                </tr>
            </table>
        </p>
