<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingSummary.aspx.cs" Inherits="BloodManagementSystem.San.BookingSummary" %>
...
<body>
    ...
    <div>
     ...
     <%--   <asp:Button ID="Button2" runat="server" PostBackUrl="~/KF/PaymentTransaction.aspx" Text="Proceed To Payment" Height="45px" Width="206px" />--%>
        ...
        <br />
        <br />
    <asp:Button ID="btnPrint" runat="server" ClientIDMode="Static" OnClientClick = "return PrintPanel();" style="margin-left: 51px; text-align: left; border-radius: 8px; padding: 12px 28px; font-weight: bold" Text="Print" Height="42px" CausesValidation="False" UseSubmitBehavior="False" />
        &nbsp;
